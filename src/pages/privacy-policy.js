const PrivacyPolicy = () => {
  return (
    <div>
      <h1>Privacy Policy for TrenThamizh</h1>

      <p>
        At TrenThamizh, accessible from https://www.trenthamizh.info/, one of
      ...
      <p>
        ...
        shared and/or collect in TrenThamizh. This policy is not applicable to
      ...
      <p>
        TrenThamizh follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, TrenThamizh uses cookies. These cookies are used
      ...
      <p>
        ...
        advertising partners of TrenThamizh.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on TrenThamizh, which are sent
      ...
      <p>
        Note that TrenThamizh has no access to or control over these cookies
      ...
      <p>
        TrenThamizh Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Request that a business that collects a consumer personal data disclose
      ...
      <p>
        TrenThamizh does not knowingly collect any Personal Identifiable
